"""Fix driver_node_type_id and retry."""
...
def main():
    ...
    # Fix BOTH node_type_id AND driver_node_type_id
    VM_TYPE = "Standard_D4s_v3"
    print(f"\nFix driver_node_type_id + node_type_id to {VM_TYPE}...")
    ...
    for cluster in settings.get("job_clusters", []):
        ...
        nc["driver_node_type_id"] = VM_TYPE  # THIS WAS THE MISSING FIX!
